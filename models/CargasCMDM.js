...
const cargaSchema = new mongoose.Schema({
    ...
    depositoSeleccionado: { type: mongoose.Schema.Types.ObjectId, ref: "DepositosCarlosMDM", required: true },
  });
  module.exports = mongoose.model("CargasCarlosMDM", cargaSchema);